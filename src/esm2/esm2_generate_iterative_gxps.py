...
fasta_file = '../../Data/esm2_experiments/entropy/gxps_exp/gxps_esm2_entropy_1000.fasta' ## file loc

N_GEN = 1000
for i in range(N_GEN):
    # generated_sequence = esm2_iterate.random_fill(protein.sequence, infill_idx=T_gxps_atc, fix=1)
    generated_sequence = esm2_iterate.entropy_fill(protein.sequence, infill_idx=T_gxps_atc, fix=1)

    seq_dict = {}
    gen_idx = f'gxps_ATC_esm2_entropy_gen_{i}'
